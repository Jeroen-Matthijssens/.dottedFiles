...
call s:initVariable("g:NERDTreeMapCloseChildren",   "E"      )
call s:initVariable("g:NERDTreeMapCloseDir",        "e"      )
call s:initVariable("g:NERDTreeMapDeleteBookmark",  ""       )
call s:initVariable("g:NERDTreeMapMenu",            "a"      )
call s:initVariable("g:NERDTreeMapHelp",            "?"      )
call s:initVariable("g:NERDTreeMapJumpFirstChild",  ""       )
call s:initVariable("g:NERDTreeMapJumpLastChild",   ""       )
call s:initVariable("g:NERDTreeMapJumpNextSibling", "n"      )
call s:initVariable("g:NERDTreeMapJumpParent",      "<S-h>"  )
call s:initVariable("g:NERDTreeMapJumpPrevSibling", "d"      )
call s:initVariable("g:NERDTreeMapJumpRoot",        "<S-d>"  )
call s:initVariable("g:NERDTreeMapOpenExpl",        ""       )
call s:initVariable("g:NERDTreeMapOpenInTab",       "<S-t>"  )
call s:initVariable("g:NERDTreeMapOpenInTabSilent", ""       )
call s:initVariable("g:NERDTreeMapOpenRecursively", "<S-o>"  )
call s:initVariable("g:NERDTreeMapOpenSplit",       "<S-n>"  )
call s:initVariable("g:NERDTreeMapOpenVSplit",      "<S-s>"  )
...
call s:initVariable("g:NERDTreeMapToggleHidden",    ""       )
call s:initVariable("g:NERDTreeMapToggleZoom",      ""       )
